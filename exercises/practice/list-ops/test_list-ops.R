...
test_that("append empty lists", {
    append c() c() |> should be Empty
})

test_that("append list to empty list", {
  expect_equal(append c() c(1, 2, 3, 4), c(1, 2, 3, 4))
})

test_that("append empty list to list", {
  expect_equal(append c(1, 2, 3, 4) c(), c(1, 2, 3, 4))
})
...
test_that("concat empty list", {
    concat c() |> should be Empty
})

test_that("concat list of lists", {
  expect_equal(concat c(c(1, 2), c(3), c(), c(4, 5, 6)), c(1, 2, 3, 4, 5, 6))
})

test_that("concat list of nested lists", {
  expect_equal(concat c(c(c(1), c(2)), c(c(3)), c(c()), c(c(4, 5, 6))), c(c(1), c(2), c(3), c(), c(4, 5, 6)))
})

test_that("filter empty list", {
    filter (fun acc -> acc % 2 = 1) c() |> should be Empty
})
...
test_that("map empty list", {
    map (fun acc -> acc + 1) c() |> should be Empty
})
...
test_that("foldl empty list", {
  expect_equal(foldl (fun acc el -> el * acc) 2 c(), 2)
})
...
test_that("foldr empty list", {
  expect_equal(foldr (fun acc el -> el * acc) 2 c(), 2)
})
...
test_that("reverse list of lists is not flattened", {
  expect_equal(reverse c(c(1, 2), c(3), c(), c(4, 5, 6)), c(c(4, 5, 6), c(), c(3), c(1, 2)))
