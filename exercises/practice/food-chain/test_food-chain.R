...
test_that("Fly", {
    expected <-
        c( "I know an old lady who swallowed a fly.";
...
test_that("Spider", {
    expected <-
        c( "I know an old lady who swallowed a spider.";
...
test_that("Bird", {
    expected <-
        c( "I know an old lady who swallowed a bird.";
...
test_that("Cat", {
    expected <-
        c( "I know an old lady who swallowed a cat.";
...
test_that("Dog", {
    expected <-
        c( "I know an old lady who swallowed a dog.";
...
test_that("Goat", {
    expected <-
        c( "I know an old lady who swallowed a goat.";
...
test_that("Cow", {
    expected <-
        c( "I know an old lady who swallowed a cow.";
...
test_that("Horse", {
    expected <-
        c( "I know an old lady who swallowed a horse.";
