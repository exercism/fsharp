...
test_that("Can create complex tree", {
    let treeData = create c(4, 2, 6, 1, 3, 5, 7)
  expect_equal(treeData |> data, 4)
  expect_equal(treeData |> left |> Option.map data, (Some 2))
