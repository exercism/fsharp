...
let ``Can create complex tree`` () =
    ...
    treeData |> left |> Option.bind right |> Option.map data |> should equal 3
    ...
    treeData |> right |> Option.map data |> should equal 6
    treeData |> right |> Option.bind left |> Option.map data |> should equal 5
    ...
    treeData |> right |> Option.bind right |> Option.map data |> should equal 7
