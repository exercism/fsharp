...
test_that("Recites first three verses of the song", {
    expected <-
        c( "On the first day of Christmas my true love gave to me: a Partridge in a Pear Tree.";
...
test_that("Recites three verses from the middle of the song", {
    expected <-
        c( "On the fourth day of Christmas my true love gave to me: four Calling Birds, three French Hens, two Turtle Doves, and a Partridge in a Pear Tree.";
