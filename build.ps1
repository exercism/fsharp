...
$nunitFrameworkDll = Join-Path $toolsDirectory "nunit/lib/nunit.framework.dll"
...
& $nugetExe install NUnit -Version 2.6.4 -ExcludeVersion -OutputDirectory $toolsDirectory
